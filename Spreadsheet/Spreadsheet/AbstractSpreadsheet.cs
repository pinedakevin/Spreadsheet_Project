...
namespace SS
{
    ...
    public abstract class AbstractSpreadsheet
    {
        ...
        /// 
        /// Checks if a name equals the starting name in the IEnumberable
        /// GetCellsToRecalculate then it throws a CircularException. 
        /// Uses recursion to visit every name that was added and continues until the end of the 
        /// iteration. Once done, it re adds to the LinkedList.
        /// </summary>
